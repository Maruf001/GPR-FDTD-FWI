# Experiment 1004: Seed3524578 Target0 Sources=8 Tx/Rx=60 Ringdown050

## Purpose

Start the seed3524578 Fibonacci branch with the original target-specific
control: target0 at 8 sources and Tx/Rx=60. This checks whether the next seed
needs target0 rescue or can proceed directly to target2.
...
/home/lam001/miniforge3/envs/FNO/bin/python -u run_multi_rebar_coordinate_optimizer.py \
  ...
  --top-k 12 \
  --progress-every 2 \
  --run-name coordinate_optimizer_variable_depth_radius_seed3524578_target0_sources8_txrx60_ringdown050_objectives
```

## Result

The final recovered coordinate state is exact and cleanly accepted:
...
relative margin: 3.591479e-02
confidence label: moderate
fallback warning: none
best misfit: 0.015913821620032458
next radius misfit: 0.016485363240124805
elapsed: 564.3 s
```
...
Seed3524578 target0 clears the standard 8-source Tx/Rx=60 control cleanly,
including late-window diagnostics. Continue the branch with target2 at the
...
Run seed3524578 target2 at 5 sources and Tx/Rx=60. That run is experiment
1006.
