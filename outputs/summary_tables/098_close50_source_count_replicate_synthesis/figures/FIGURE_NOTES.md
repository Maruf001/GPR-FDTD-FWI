...
Source3 seed count: `2`.
Source3 seed values: `13,34`.
Source3 replicated failure: `True`.
Source-count transition supported: `True`.
Final source3 seed21 replicate ready: `True`.
