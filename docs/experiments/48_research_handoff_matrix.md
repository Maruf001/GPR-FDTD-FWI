...
| Multi-rebar source-shape compact/wide x/z gate | Left, center, and right targets correct over compact windows; center and left also passed dense Stage 4C radius stress | Positive margins against 6.2 mm; weakest margin 1.813e-04 in center 10% noisy-ringdown row | Source-basis coefficients recovered injected ringdown 0.20 and about 0.25; shifted z91/r6.8-7.0 branch appears but is not a near-tie | Experiment 51, runs 425-433 | 5 candidates cost 161 s; 27 candidates cost 873-882 s; 45 candidates cost 1472 s; 125 candidates cost 4076 s; dense 325 candidates cost about 10500 s | Run dense Stage 4C grid on right target to complete all-target dense coverage |
...
5. For source-shape calibration, fixed-x/z, compact all-target, compact
   center hard-noise/high-radius, 5x5 high-radius, dense center, and dense left
   gates pass; next run the dense Stage 4C grid on the right target.
