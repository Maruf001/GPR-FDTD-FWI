...
| Multi-rebar source-shape compact/wide x/z gate | Left, center, and right targets correct over compact and dense Stage 4C radius windows; synthesis has 48/48 truth rows; first coupled 6.2 mm seed pass recovers exact all-target state | Positive margins against 6.2 mm; weakest fixed-neighbor margin 1.006e-04; coupled pass rows are all weak with 6.0-6.2 mm intervals | Source-basis coefficients recovered injected ringdown 0.20 and about 0.25; dense seed55 keeps z91/r6.8-7.0 branch secondary; coupled 440 recovers ringdown about 0.25 | Experiment 51/52, runs 425-440 | 5 candidates cost 161 s; 27 candidates cost 849-882 s; coupled 3x27 pass costs 2643 s; 45 candidates cost 1472 s; 125 candidates cost about 4080 s; dense 325 candidates cost about 10200-10600 s | Repeat coupled source-shape pass from a harder x/z/r perturbed seed before dense coupled sweeps |
...
5. For source-shape calibration, fixed-x/z, compact all-target, compact
   ...
   replication, sparse seed55, dense seed55, seed synthesis, and first coupled
   6.2 mm-radius seed checks pass; next run a harder coupled x/z/r perturbed
   seed before any dense coupled sweep.
